...
** Ruby
    ...
    - Put in your emacs configuration.
      ...
      #+END_SRC
** Dart
Latest version of [[https://github.com/emacs-lsp/lsp-dart][LSP Dart]] already has support for ~dap-mode~.

You only need to run ~dap-dart-setup~ to setup ~dap-dart~ automatically and then you are good to
debug dart.
** LLDB
*** Installation
